...
include("includes/db.php");
    ...
    if(isset($_POST['change_pass'])){
		...
		$sel_pass="select * from customer where customer_password='$current_pass' AND customer_email='$user'";
		...
		exit();
			...
			$update_pass="update customer set customer_password='$new_pass' where customer_email='$user'";
